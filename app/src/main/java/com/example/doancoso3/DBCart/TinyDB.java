package com.example.doancoso3.DBCart;
...
public class TinyDB {
    ...
    public void putListObject(String key, ArrayList<GioHang> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (GioHang player : playerList) {
    ...
    public ArrayList<GioHang> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<GioHang> playerList = new ArrayList<GioHang>();

        for (String jObjString : objStrings){
            GioHang player = gson.fromJson(jObjString,GioHang.class);
